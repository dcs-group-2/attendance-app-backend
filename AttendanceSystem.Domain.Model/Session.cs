...
public class Session
{
    ...
    public Session(Course course, List<Student> students, DateTime startTime, DateTime endTime)
    {
        Course = course;
        StartTime = startTime;
        EndTime = endTime;
    ...
    public void SetAttendance(Guid studentId, AttendanceKind kind)
    {
        Register.Single(r => r.Student.Id == studentId).Record = kind;
    }
}